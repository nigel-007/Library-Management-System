...
public class Books_Author extends Frame implements ActionListener
{  static String USER ;
    static  String PASS;
    ...
    {   addWindowListener(new WindowAdapter()
        ...
        jButton4 = new Button("Select Author Books");
        jButton4.setFont(myFont);
        add(jButton4);
        jButton4.addActionListener(this);
        Books_Author.initconnectionData();
    }
   ...
   {  USER ="root";
    ...
    {   String g=e.getActionCommand();
        ...
        if(g.equals("Select Author Books"))
        {   try
            {   Class.forName(driver);
                System.out.println("Connecting to database...");
         Connection conn =
          DriverManager.getConnection(DB_URL, USER, PASS);
                String s= "select author.a_name,book.Title,book.Category,book.pg_cnt from author natural join writes natural join book;";
    ...
    {   Books_Author e=new Books_Author();
