...
public class Book_Count extends Frame implements ActionListener
{  static String USER ;
    static  String PASS;
    ...
    {   addWindowListener(new WindowAdapter()
        ...
        jButton4 = new Button("Select Number of Books");
        jButton4.setFont(myFont);
        add(jButton4);
        jButton4.addActionListener(this);
        Book_Count.initconnectionData();
    }
   ...
   {  USER ="root";
    ...
    {   String g=e.getActionCommand();
        ...
        if(g.equals("Select Number of Books"))
        {   try
            {   Class.forName(driver);
                System.out.println("Connecting to database...");
         Connection conn =
          DriverManager.getConnection(DB_URL, USER, PASS);
                String s= "select Category,count(Bid) from book group by Category;";
