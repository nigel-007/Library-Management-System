...
public class Delete_User extends Frame implements ActionListener
{   Choice Uid;Button jButton;Label jLabel1;
    Label jLabel2;
    Delete_User()
    {   Uid=new Choice();
        ...
        add(jLabel1);add(Uid);add(jButton);
    ...
    { String s=e.getActionCommand();
      ...
      {     try
        {   Statement stmt = null;
            String Uno=Uid.getSelectedItem().toString();
            Class.forName(Library.driver);
            System.out.println("Connecting to database...");
            Connection conn = DriverManager.
            ...
            String sql = "delete from user where Uid="+Uno; 
