...
public class SelectForm extends Frame implements ActionListener
{  static String USER ;
    static  String PASS;
        ...
        {   try
         ...
         Connection conn =
          DriverManager.getConnection(DB_URL, USER, PASS);
                String s= "select * from book where Category!='Educational';";
