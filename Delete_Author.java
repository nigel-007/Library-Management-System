...
public class Delete_Author extends Frame implements ActionListener
{   Choice aid;Button jButton;Label jLabel1;
    Label jLabel2;
    Delete_Author()
    {   aid=new Choice();
        ...
        add(jLabel1);add(aid);add(jButton);
    ...
    { String s=e.getActionCommand();
      ...
      {     try
        {   Statement stmt = null;
            String ano=aid.getSelectedItem().toString();
            Class.forName(Library.driver);
            System.out.println("Connecting to database...");
            Connection conn = DriverManager.
            ...
            String sql = "delete from author where aid="+ano; 
